...
export const postVariantsBody = zod.object({
  ...
  publicId: zod.coerce
    ...
    .max(
      postVariantsBodyPublicIdMax,
      "Public ID نمی‌تواند بیش از ۱۰۰ کاراکتر باشد",
    ),
  barcode: zod
    .union([
      zod.coerce
        .string()
        .max(
          postVariantsBodyBarcodeMaxOne,
          "بارکد نمی‌تواند بیش از ۵۰ کاراکتر باشد",
        ),
      zod.null(),
    ])
    .optional(),
  mpn: zod
    .union([
      zod.coerce
        .string()
        .max(
          postVariantsBodyMpnMaxOne,
          "MPN نمی‌تواند بیش از ۱۰۰ کاراکتر باشد",
        ),
      zod.null(),
    ])
    .optional(),
  titleOverride: zod
    .union([
      zod.coerce
        .string()
        .max(
          postVariantsBodyTitleOverrideMaxOne,
          "عنوان نمی‌تواند بیش از ۲۰۰ کاراکتر باشد",
        ),
      zod.null(),
    ])
    .optional(),
  descriptionOverride: zod
    .union([
      zod.coerce
        .string()
        .max(
          postVariantsBodyDescriptionOverrideMaxOne,
          "توضیحات نمی‌تواند بیش از ۵۰۰ کاراکتر باشد",
        ),
      zod.null(),
    ])
    .optional(),
  ...
  slug: zod
    .union([
      zod.coerce
        .string()
        .max(
          postVariantsBodySlugMaxOne,
          "Slug نمی‌تواند بیش از ۱۰۰ کاراکتر باشد",
        ),
      zod.null(),
    ])
    .optional(),
  metaTitle: zod
    .union([
      zod.coerce
        .string()
        .max(
          postVariantsBodyMetaTitleMaxOne,
          "Meta title نمی‌تواند بیش از ۲۰۰ کاراکتر باشد",
        ),
      zod.null(),
    ])
    .optional(),
  metaDescription: zod
    .union([
      zod.coerce
        .string()
        .max(
          postVariantsBodyMetaDescriptionMaxOne,
          "Meta description نمی‌تواند بیش از ۵۰۰ کاراکتر باشد",
        ),
      zod.null(),
    ])
    .optional(),
...
export const getVariantsQueryParams = zod.object({
  ...
  sku: zod
    .union([
      zod.coerce.string().max(200, "طول SKU بیش از حد مجاز است"),
      zod.null(),
    ])
    .optional(),
  barcode: zod
    .union([
      zod.coerce.string().max(200, "طول بارکد بیش از حد مجاز است"),
      zod.null(),
    ])
    .optional(),
  mpn: zod
    .union([
      zod.coerce.string().max(200, "طول MPN بیش از حد مجاز است"),
      zod.null(),
    ])
    .optional(),
  publicId: zod
    .union([zod.uuid("شناسه عمومی معتبر نیست"), zod.null()])
    .optional(),
  productId: zod
    .union([zod.uuid("شناسه محصول معتبر نیست"), zod.null()])
    .optional(),
...
export const patchVariantsIdBody = zod.object({
  ...
  barcode: zod
    .union([
      zod.coerce.string().max(50, "بارکد نمی‌تواند بیش از ۵۰ کاراکتر باشد"),
      zod.null(),
    ])
    .optional(),
  mpn: zod
    .union([
      zod.coerce.string().max(100, "MPN نمی‌تواند بیش از ۱۰۰ کاراکتر باشد"),
      zod.null(),
    ])
    .optional(),
  titleOverride: zod
    .union([
      zod.coerce.string().max(200, "عنوان نمی‌تواند بیش از ۲۰۰ کاراکتر باشد"),
      zod.null(),
    ])
    .optional(),
  descriptionOverride: zod
    .union([
      zod.coerce.string().max(500, "توضیحات نمی‌تواند بیش از ۵۰۰ کاراکتر باشد"),
      zod.null(),
    ])
    .optional(),
  ...
  slug: zod
    .union([
      zod.coerce.string().max(100, "Slug نمی‌تواند بیش از ۱۰۰ کاراکتر باشد"),
      zod.null(),
    ])
    .optional(),
  metaTitle: zod
    .union([
      zod.coerce
        .string()
        .max(200, "Meta title نمی‌تواند بیش از ۲۰۰ کاراکتر باشد"),
      zod.null(),
    ])
    .optional(),
  metaDescription: zod
    .union([
      zod.coerce
        .string()
        .max(500, "Meta description نمی‌تواند بیش از ۵۰۰ کاراکتر باشد"),
      zod.null(),
    ])
    .optional(),
