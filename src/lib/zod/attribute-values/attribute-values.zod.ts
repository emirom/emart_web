 ...
 */
export const getAttributeValuesQueryFieldDefaultOne = "createdAt";
export const getAttributeValuesQueryFieldMaxOne = 200;
export const getAttributeValuesQueryOrderDefaultOne = "desc";export const getAttributeValuesQuerySkipMin = 0;
...
export const getAttributeValuesQueryParams = zod.object({
  "field": zod.union([zod.coerce.string().max(getAttributeValuesQueryFieldMaxOne),zod.null()]).optional().describe('Field to sort by'),
