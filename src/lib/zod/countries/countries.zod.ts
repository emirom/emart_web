 ...
 */
export const getCountriesQueryFieldDefaultOne = "createdAt";
export const getCountriesQueryFieldMaxOne = 200;
export const getCountriesQueryOrderDefaultOne = "desc";export const getCountriesQuerySkipMin = 0;
...
export const getCountriesQueryParams = zod.object({
  "field": zod.union([zod.coerce.string().max(getCountriesQueryFieldMaxOne),zod.null()]).optional().describe('Field to sort by'),
