...
export const postGuaranteesBodyIsInternationalDefault = false;export const postGuaranteesBodyClaimProcessMaxOne = 200;
export const postGuaranteesBodyIsActiveDefault = true;export const postGuaranteesBodySortOrderDefault = 0;export const postGuaranteesBodySepidarGuaranteeIdMaxOne = 200;
...
export const postGuaranteesBody = zod.object({
  ...
  "currencyId": zod.union([zod.uuid(),zod.null()]).optional().describe('Currency ID of guarantee price'),
 ...
 */
export const getGuaranteesQueryFieldDefaultOne = "createdAt";
export const getGuaranteesQueryFieldMaxOne = 200;
export const getGuaranteesQueryOrderDefaultOne = "desc";export const getGuaranteesQuerySkipMin = 0;
...
export const getGuaranteesQueryParams = zod.object({
  "field": zod.union([zod.coerce.string().max(getGuaranteesQueryFieldMaxOne),zod.null()]).optional().describe('Field to sort by'),
...
export const patchGuaranteesIdBodyIsInternationalDefault = false;export const patchGuaranteesIdBodyClaimProcessMaxOne = 200;
export const patchGuaranteesIdBodyIsActiveDefault = true;export const patchGuaranteesIdBodySortOrderDefault = 0;export const patchGuaranteesIdBodySepidarGuaranteeIdMaxOne = 200;
