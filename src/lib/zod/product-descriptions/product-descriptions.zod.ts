 ...
 */
export const getProductDescriptionsQueryFieldDefaultOne = "createdAt";
export const getProductDescriptionsQueryFieldMaxOne = 200;
export const getProductDescriptionsQueryOrderDefaultOne = "desc";export const getProductDescriptionsQuerySkipMin = 0;
...
export const getProductDescriptionsQueryParams = zod.object({
  "field": zod.union([zod.coerce.string().max(getProductDescriptionsQueryFieldMaxOne),zod.null()]).optional().describe('Field to sort by'),
