...
export const getProductsIdResponse = zod
  .object({
    ...
    name: zod.coerce
      .string()
      .min(getProductsIdResponseNameMin)
      .max(getProductsIdResponseNameMax)
      .describe("Product name in native language"),
    enName: zod.coerce
      .string()
      .min(getProductsIdResponseEnNameMin)
      .max(getProductsIdResponseEnNameMax)
      .describe("English product name for SEO and international users"),
    categoryId: zod.uuid().describe("Category ID this product belongs to"),
    brandId: zod
      .union([zod.uuid(), zod.null()])
    ...
    averageRating: zod
      ...
      .optional()
      .describe("Computed average rating from 0 to 5, from inventory reviews"),
    totalReviews: zod
      .union([zod.coerce.number(), zod.null()])
      .optional()
