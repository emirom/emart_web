...
export const getProvincesQueryOrderDefaultOne = "desc";export const getProvincesQuerySkipMin = 0;
...
export const getProvincesQueryParams = zod.object({
  "field": zod.union([zod.coerce.string().max(getProvincesQueryFieldMaxOne),zod.null()]).optional().describe('Field to sort by'),
