...
export const getStoresQueryOrderDefaultOne = "desc";export const getStoresQuerySkipMin = 0;
...
export const getStoresQueryParams = zod.object({
  "field": zod.union([zod.coerce.string().max(getStoresQueryFieldMaxOne),zod.null()]).optional().describe('Field to sort by'),
