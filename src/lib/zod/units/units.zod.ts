...
export const getUnitsIdResponseTitleMin = 2;

export const getUnitsIdResponseTitleMax = 100;
...
export const getUnitsIdResponse = zod.object({
  ...
  "title": zod.coerce.string().min(getUnitsIdResponseTitleMin).max(getUnitsIdResponseTitleMax).describe('Unit title/name for measurement categorization')
