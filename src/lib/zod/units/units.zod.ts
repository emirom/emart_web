...
export const getUnitsQueryOrderDefaultOne = "desc";export const getUnitsQuerySkipMin = 0;
...
export const getUnitsQueryParams = zod.object({
  "field": zod.union([zod.coerce.string().max(getUnitsQueryFieldMaxOne),zod.null()]).optional().describe('Field to sort by'),
