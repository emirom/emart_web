...
export default function ProductColor() {
  ...
  return (
    <div>
      <h2 className=" hidden lg:inline-block text-sm font-medium mb-1">
        انتخاب رنگ
      </h2>
      <fieldset
        className="flex flex-wrap gap-2 items-stretch my-3 lg:my-0"
      ...
      >
        ...
        {COLORS.map((color) => (
          ...
          >
            ...
            <span
              className={cn(
                "text-sm font-semibold text-center select-none lg:text-xs",
